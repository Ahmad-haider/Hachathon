...
export default function signin() {
    ...
    const {mail,pass,signuphandler,email,password} = useSignup()
               ...
               <div style={{}}>
                  ...
                  <Form>
                     <Form.Group className="mb-3" controlId="formBasicEmail" style={{ width: '39vh', }}>
                        ...
                        <br />
                     <input value={email} onChange={mail} type="email" placeholder="" style={{width:'40vh', height:'4vh', }} />
                     ...
                     <Form.Group className="mb-3" controlId="formBasicPassword" style={{ width: '39vh', }}>
                        ...
                        <br />
                        <input value={password} onChange={pass} type="password" placeholder="" style={{width:'40vh', height:'4vh',}} />
